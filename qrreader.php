...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('QR\bg.jpg');
        }
...
<body>
    ...
    <div class="container">
        ...
        <button class="copy-button" disabled>Copy</button> <!-- Copy button -->
    </div>
    ...
    <script>
        ...
        function onScanSuccess(qrCodeMessage) {
            ...
            messageIdElement.innerText = `Scanned message: ${qrCodeMessage}`;
        ...
        document.querySelector(".copy-button").addEventListener("click", function() {
            ...
            navigator.clipboard.writeText(idToCopy).then(function() {
                alert("Message copied to clipboard: " + idToCopy);
            }, function() {
